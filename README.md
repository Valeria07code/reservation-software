...
Este proyecto permitió aplicar conceptos de programación orientada a objetos y manejo avanzado de excepciones en Python, desarrollando una solución modular, estable y robusta para la gestión de clientes, servicios y reservas sin utilizar bases de datos.# Software FJ - Sistema Integral de Gestión de Clientes, Servicios y Reservas
